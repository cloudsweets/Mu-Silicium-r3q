...
class CommonPlatform ():
    PackagesSupported = ("r3qPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('r3q', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "r3q", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "r3qPkg/r3q.dsc", "Platform Hardcoded")
